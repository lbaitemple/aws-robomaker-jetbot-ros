...
1. Open the RoboMaker IDE and navigate to the terminal and clone this Git repo to the development machine:
    ...
    cd ~/environment
    git clone -b aarch64 https://github.com/lbaitemple/aws-robomaker-jetbot-ros jetbot
    ```
...
![Alt text](img/aws.png?raw=true "AWS endpoint description in AWS academy" | width=100)
